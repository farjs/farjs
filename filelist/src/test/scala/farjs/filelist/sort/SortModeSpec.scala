...
class SortModeSpec extends TestSpec {
  ...
  private val item0 = FileListItem("item.bin", size = 2, atimeMs = 1, mtimeMs = 4, ctimeMs = 2)
  private val item1 = FileListItem("Item.bin", size = 1, atimeMs = 1, mtimeMs = 3, ctimeMs = 2)
  private val item2 = FileListItem("item2.BIN", size = 4, atimeMs = 2, mtimeMs = 1, ctimeMs = 3)
  private val item3 = FileListItem("Item3.zip", size = 3, atimeMs = 4, mtimeMs = 2, ctimeMs = 4)
  private val item4 = FileListItem("item4.ZIP", size = 3, atimeMs = 3, mtimeMs = 2, ctimeMs = 1)
