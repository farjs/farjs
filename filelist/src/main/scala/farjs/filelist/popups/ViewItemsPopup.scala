...
import farjs.filelist.FileListActions.{FileListItemsViewAction, FileListItemsViewedAction}
    ...
    def viewItems(): Unit = {
      ...
      resultF.onComplete {
        ...
        case Failure(_) =>
          ...
          props.dispatch(FileListItemsViewAction(FutureTask("Viewing Items", resultF)))
      }
    }
