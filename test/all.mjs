...
await import("./copymove/CopyMoveUi.test.mjs");
...
await import("./fs/popups/DriveController.test.mjs");
await import("./fs/popups/DrivePopup.test.mjs");
await import("./fs/popups/FoldersHistoryController.test.mjs");
await import("./fs/popups/FoldersHistoryPopup.test.mjs");
...
await import("./fs/FSFileListApi.test.mjs");
...
await import("./viewer/ViewerController.test.mjs");
await import("./viewer/ViewerEvent.test.mjs");
...
await import("./viewer/ViewerPlugin.test.mjs");
