      ...
      <.log(
        ...
        ^.content :=
          """{white-fg}{#000-bg}#000{/}{white-fg}{#005-bg}#005{/}{white-fg}{#008-bg}#008{/}{white-fg}{#00a-bg}#00a{/}{black-fg}{#00c-bg}#00c{/}{black-fg}{#00e-bg}#00e{/}
            ...
            |
            |{white-fg}{#000-bg}#000{/}{white-fg}{#333-bg}#333{/}{white-fg}{#555-bg}#555{/}{white-fg}{#888-bg}#888{/}{white-fg}{#aaa-bg}#aaa{/}{black-fg}{#ccc-bg}#ccc{/}{black-fg}{#fff-bg}#fff{/}""".stripMargin
      )()
    )
  }
}
